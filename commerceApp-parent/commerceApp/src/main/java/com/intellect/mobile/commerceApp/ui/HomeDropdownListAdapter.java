...
/**
 * Dropdown list adapter to display commodity. and other context-related
 * activity links
 */
public class HomeDropdownListAdapter extends SingleTypeAdapter<Object> {
    ...
    public HomeDropdownListAdapter(final Context context,
	    final List<Comment> orgs, final ImageLoader avatars) {
     ...
     * @return this adapter
     */
    public HomeDropdownListAdapter setOrgs(final List<Comment> orgs) {
